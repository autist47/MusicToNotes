...
function create_menu(){
    ...
    circle_1 = [3, 100, ['#70716B'], [["img/note1_2.png", "img/note1_4.png", "img/note1_8.png"], [false]], ["add_note(some_clicked, [1, 2], global_flag)", "add_note(some_clicked, [1, 4], global_flag)", "add_note(some_clicked, [1, 8], global_flag)"] ]
    myArr = [circle_1]
    ...
    circle_1 = [2, 100, ['#70716B'], [["img/scripka.png", "img/bas.png"], [false]], ["add_key(some_clicked, 'scripka', global_flag)", "add_key(some_clicked, 'bas', global_flag)"] ]
    myArr = [circle_1]
    ...
    circle_1 = [3, 100, ['#70716B'], [["img/2_4.png", "img/3_4.png", "img/4_4.png"], [false]], ["add_dimension(some_clicked, [2, 4])", "add_dimension(some_clicked, [3, 4])", "add_dimension(some_clicked, [4, 4])"] ]
    myArr = [circle_1]
    ...
    // --------------------------------------------------------------note menu --------------------------------------------------------------
    circle_1 = [3, 100, ['gray','gray',"gray"], [["img/key_setting.png", "img/rubbish.png", "img/plus.png"], [false]], ["click_change_note()", "click_delete_note()", "DefaultFuncForMenu()"], [false, false, true] ]
    circle_2 = [[3], 165, ['gray','gray',"gray"], [["img/note1_4.png", "img/scripka.png", "img/3_4.png"], [true]], ["DefaultFuncForMenu()", "DefaultFuncForMenu()", "click_plus_dimension()"], [true, true, false] ]
    circle_3 = [[2], 205, ['gray','gray',"gray"], [["img/y.png", "img/n.png"], [true]], ["click_plus_note(true)", "click_plus_note(false)", "click_plus_key(true)", "click_plus_key(false)"] ]
    ...
    circle_1 = [3, 100, ['#70716B'], [["img/note1_2.png", "img/note1_4.png", "img/note1_8.png"], [false]], ["change_note(some_clicked, \'1/2\', false)", "change_note(some_clicked, \'1/4\', false)", "change_note(some_clicked, \'1/8\', false)"] ]
    myArr = [circle_1]
    ...
    // --------------------------------------------------------------key menu --------------------------------------------------------------
    circle_1 = [3, 100, ['#70716B'], [["img/key_setting.png", "img/rubbish.png", "img/plus.png"], [false]], ["click_change_key()", "DefaultFuncForMenu()", "DefaultFuncForMenu()"], [false, true, true] ]
    circle_2 = [[2], 165, ['gray','gray',"gray"], [["img/y.png", "img/y.png", "img/y.png", "img/n.png", "img/note1_4.png", "img/3_4.png"], [true]], ["DefaultFuncForMenu()", "DefaultFuncForMenu()", "click_del_key(true)", "click_del_key(false)", "click_plus_note(true)", "click_plus_dimension()"] ]
    ...
    circle_1 = [4, 100, ['#70716B'], [["img/scripka.png", "img/bas.png"], [false]], ["change_key(some_clicked, \'scripka\')", "change_key(some_clicked, \'bas\')", "change_key(some_clicked, \'scripka\', true)", "change_key(some_clicked, \'bas\', true)"] ]
    myArr = [circle_1]
    ...
    // --------------------------------------------------------------dimension menu --------------------------------------------------------------
    circle_1 = [3, 100, ['#70716B'], [["img/key_setting.png", "img/rubbish.png", "img/plus.png"], [false]], ["click_change_dimension()", "click_del_dimension()", "DefaultFuncForMenu()"], [false, false, true] ]
    circle_2 = [[2], 165, ['gray','gray',"gray"], [["img/note1_4.png", "img/scripka.png"], [true]], ["click_plus_note(true)", "DefaultFuncForMenu()"],[false, true] ]
    circle_3 = [[2], 205, ['gray','gray',"gray"], [["img/y.png", "img/n.png"], [true]], ["click_plus_key(true)", "click_plus_key(false)"] ]
    myArr = [circle_1, circle_2, circle_3]
    ...
    circle_1 = [3, 100, ['#70716B'], [["img/2_4.png", "img/3_4.png", "img/4_4.png"], [false]], ["change_dimension(some_clicked, [2,4])", "change_dimension(some_clicked, [3,4])", "change_dimension(some_clicked, [4,4])"] ]
    myArr = [circle_1]
